...
class PeliculaProximamenteAdapter(private var peliculaProximamenteList: ArrayList<Pelicula>, private val listener: OnPeliculasProximamenteItemListener) :
    ...
    override fun getItemCount(): Int {
        return peliculaProximamenteList.size
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val pelicula = peliculaProximamenteList[position]
        val viewHolder = holder as ViewHolder
        viewHolder.bind(pelicula, listener)
    }

    fun updateData(pelicula: List<Pelicula>) {
        peliculaProximamenteList.clear()
        peliculaProximamenteList.addAll(pelicula)
    ...
    class ViewHolder(
        ...
        fun bind(peliculas: Pelicula, listener: OnPeliculasProximamenteItemListener) {
            Glide.with(itemView)
            ...
            binding.imgPelicula.setOnClickListener {
                listener.onPeliculasProximamenteItemClick(peliculas)
            }
        }

    }

    interface OnPeliculasProximamenteItemListener {
        fun onPeliculasProximamenteItemClick(peliculas: Pelicula)
    }
}