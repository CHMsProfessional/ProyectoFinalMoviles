...
class PeliculaPreventaAdapter(private var peliculasPreventaList: ArrayList<Pelicula>, private val listener: OnPeliculasPreventaItemListener) :
    ...
    override fun getItemCount(): Int {
        return peliculasPreventaList.size
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val pelicula = peliculasPreventaList[position]
        val viewHolder = holder as ViewHolder
        viewHolder.bind(pelicula, listener)
    }

    fun updateData(pelicula: List<Pelicula>) {
        peliculasPreventaList.clear()
        peliculasPreventaList.addAll(pelicula)
    ...
    class ViewHolder(
        ...
        fun bind(peliculas: Pelicula, listener: OnPeliculasPreventaItemListener) {
            Glide.with(itemView)
            ...
            binding.imgPelicula.setOnClickListener {
                listener.onPeliculasPreventaItemClick(peliculas)
            }
        }

    }

    interface OnPeliculasPreventaItemListener {
        fun onPeliculasPreventaItemClick(peliculas: Pelicula)
    }
}